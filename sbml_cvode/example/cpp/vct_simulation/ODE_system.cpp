...
state_type ODE_system::_class_parameter = state_type(148, 0);
...
void ODE_system::setup_class_parameters(Param& param){
    ...
    //dose_Nivo, mwbbed5e91_91a4_4999_8e4c_776961888bca, index: 61
    //Unit: mole^(1)
    _class_parameter[61] = PFILE(127) * 1.0;
    //Ki, mw743be1bf_4a0e_43d6_b33e_5c1d0fe34fd9, index: 62
    //Unit: dimensionless^(1)
    _class_parameter[62] = PFILE(128) * 1.0;
    //t_init_Nivo, mw9b783786_07c2_4e85_b100_3a1719239ad7, index: 63
    //Unit: second^(1)
    _class_parameter[63] = PFILE(133) * 86400.0;
    //n_dose_Nivo, mw1626f055_6b5e_4949_8400_ca72179385d7, index: 64
    //Unit: dimensionless^(1)
    _class_parameter[64] = PFILE(135) * 1.0;
    //t_infus_Nivo, mwc4c58dbd_a7f9_4753_8913_737168c45426, index: 65
    //Unit: second^(1)
    _class_parameter[65] = PFILE(136) * 3600.0;
    //cl_Nivo, mw4b42ef90_788a_44b8_8ad9_345d2ff1616c, index: 66
    //Unit: second^(-1)
    _class_parameter[66] = PFILE(141) * 1.0;
    //f_vol_peri_Nivo, mwc9a8e723_fb54_466d_9a75_d4e537deb0d8, index: 67
    //Unit: dimensionless^(1)
    _class_parameter[67] = PFILE(142) * 1.0;
    //P_ratio_Nivo, mw78b33e72_837d_443a_90b1_d17152aa294b, index: 68
    //Unit: dimensionless^(1)
    _class_parameter[68] = PFILE(143) * 1.0;
    //f_vol_cent_Nivo, mwec239c07_e461_436c_a20a_f5197a0cd9e9, index: 69
    //Unit: dimensionless^(1)
    _class_parameter[69] = PFILE(144) * 1.0;
    //Teff_PD1_tot, mw9526100e_d434_4445_801c_c3a93f0f9988, index: 70
    //Unit: mole^(1)
    _class_parameter[70] = PFILE(145) * 1.66053872801495e-24;
    //C1_PDL1_tot, mwc4ebd215_5573_4623_8049_14f8af4936eb, index: 71
    //Unit: mole^(1)
    _class_parameter[71] = PFILE(146) * 1.66053872801495e-24;
    //C1_PDL2_tot, mw43b17fee_3af0_4f22_9e34_95e576da9a1d, index: 72
    //Unit: mole^(1)
    _class_parameter[72] = PFILE(147) * 1.66053872801495e-24;
    //Kd_PD1_PDL1, mwfc9acb4e_aa25_44a4_8d67_50cd19961d13, index: 73
    //Unit: metre^(-2)mole^(1)
    _class_parameter[73] = PFILE(148) * 1.66053872801495e-12;
    //k_on_PD1_PDL1, mwf882c962_c52d_470c_ac7d_50327d3d9153, index: 74
    //Unit: metre^(2)mole^(-1)second^(-1)
    _class_parameter[74] = PFILE(149) * 602214199000.0;
    //K_C1_PDLX_Teff_PD1, mwaa9b2cc2_9db7_49d7_acbc_460333aaf5c5, index: 75
    //Unit: mole^(1)
    _class_parameter[75] = PFILE(151) * 1.66053872801495e-24;
    //Kd_PD1_PDL2, mwb8ecc527_47f5_4627_80e0_41c6c47e601f, index: 76
    //Unit: metre^(-2)mole^(1)
    _class_parameter[76] = PFILE(152) * 1.66053872801495e-12;
    //k_on_PD1_PDL2, mw6beac7e2_8e8d_4780_b363_e32f875f4c1a, index: 77
    //Unit: metre^(2)mole^(-1)second^(-1)
    _class_parameter[77] = PFILE(153) * 602214199000.0;
    //n_PD1_PDLX, mw97c34844_a1ac_4f29_ab3f_25b1af316915, index: 78
    //Unit: dimensionless^(1)
    _class_parameter[78] = PFILE(155) * 1.0;
    //V_E, mwe1d68345_a93e_4d6a_9a67_b36c204f9f38, index: 79
    //Unit: metre^(3)
    _class_parameter[79] = PFILE(156) * 0.0010000000000000007;
    //V_intake, mw4ef922d0_b5ea_426e_aaa7_5909aec9897c, index: 80
    //Unit: metre^(3)
    _class_parameter[80] = PFILE(157) * 0.0010000000000000007;
    //p_per_P, mw5682b886_b3fd_4aed_979f_a9ab7cd832a3, index: 81
    //Unit: dimensionless^(1)
    _class_parameter[81] = PFILE(158) * 1.0;
    //k_int_Cp, mw3b23e211_5736_4d71_819c_598bf808307b, index: 82
    //Unit: second^(-1)
    _class_parameter[82] = PFILE(159) * 1.15740740740741e-05;
    //k_deg_Cp, mwdbe183e4_795d_4b08_9ad6_c1411036ef80, index: 83
    //Unit: second^(-1)
    _class_parameter[83] = PFILE(160) * 1.15740740740741e-05;
    //k_deg_cpt, mw44ec38bf_8ddf_46ad_baf3_a5c57c304b48, index: 84
    //Unit: second^(-1)
    _class_parameter[84] = PFILE(161) * 1.15740740740741e-05;
    //k_deg_cpt_M, mw67c70ed5_4b7f_44e9_9582_90e7008bb696, index: 85
    //Unit: second^(-1)
    _class_parameter[85] = PFILE(162) * 1.15740740740741e-05;
    //k_int_Dend, mw390f216c_90ae_459c_a7b5_4b80ed1af617, index: 86
    //Unit: second^(-1)
    _class_parameter[86] = PFILE(163) * 1.15740740740741e-05;
    //k_deg_Dend, mw3628e4cb_ec7e_4ff8_8cb2_57f2b446b683, index: 87
    //Unit: second^(-1)
    _class_parameter[87] = PFILE(164) * 1.15740740740741e-05;
    //k_deg_p, mw5232a4e1_43ac_4a82_aed3_0b6e8efc6fe2, index: 88
    //Unit: second^(-1)
    _class_parameter[88] = PFILE(165) * 1.15740740740741e-05;
    //k_deg_p_M, mwcfff7554_d4db_49f0_8a06_e8811c731172, index: 89
    //Unit: second^(-1)
    _class_parameter[89] = PFILE(166) * 1.15740740740741e-05;
    //M1_0, mwb09e971e_3def_461b_b0bd_9f6b9bd01c9d, index: 90
    //Unit: mole^(1)
    _class_parameter[90] = PFILE(167) * 1.0;
    //k_deg_M, mw9dc61aae_3f5c_4dd5_9cca_2d0de1a9b4ea, index: 91
    //Unit: second^(-1)
    _class_parameter[91] = PFILE(168) * 1.15740740740741e-05;
    //k_int_M, mwf224e931_bed1_4c27_8343_fdf98296e85a, index: 92
    //Unit: second^(-1)
    _class_parameter[92] = PFILE(169) * 1.15740740740741e-05;
    //k_ext_p_M, mw290a29c2_4f1e_4adb_90f6_41d7fb330d59, index: 93
    //Unit: second^(-1)
    _class_parameter[93] = PFILE(170) * 1.15740740740741e-05;
    //n_clone_Treg, mw815d0ce3_fedd_4629_801b_b8f71beb07c7, index: 94
    //Unit: dimensionless^(1)
    _class_parameter[94] = PFILE(171) * 1.0;
    //n_clone_p1_0, mw0a301512_d8fa_4a06_bd01_ad2617e826ee, index: 95
    //Unit: dimensionless^(1)
    _class_parameter[95] = PFILE(172) * 1.0;
    //Kd_p1_0_M1, mw22747238_c508_425c_88a0_351a1870a800, index: 96
    //Unit: metre^(-3)mole^(1)
    _class_parameter[96] = PFILE(173) * 1.0000000000000008e-06;
    //k_on_p1_0_M1, mw48329238_da42_4d4c_afbd_c8b1dc9e3332, index: 97
    //Unit: metre^(3)mole^(-1)second^(-1)
    _class_parameter[97] = PFILE(174) * 1.1574074074074112e-08;
    //Kd_cpt_M1, mwb54adfbf_e1cb_4b0d_9887_6c7ea12c83b2, index: 98
    //Unit: metre^(-3)mole^(1)
    _class_parameter[98] = PFILE(176) * 1.0000000000000008e-06;
    //k_on_cpt_M1, mwebc095fb_07e3_42a8_8b1d_85414d9cd17a, index: 99
    //Unit: metre^(3)mole^(-1)second^(-1)
    _class_parameter[99] = PFILE(177) * 1.1574074074074112e-08;
    //k_ext_cpt_M, mwa5d89150_2ddd_4a61_b897_338f2604ca94, index: 100
    //Unit: second^(-1)
    _class_parameter[100] = PFILE(179) * 1.15740740740741e-05;
    //APC0_Tum, mw96d1c104_95de_4f05_a2fc_ad9548c6ba35, index: 101
    //Unit: metre^(-3)mole^(1)
    _class_parameter[101] = PFILE(180) * 1.6605387280149534e-18;
    //APC0_LN, mw023c6da2_73a3_4394_93dc_5505c9346c7b, index: 102
    //Unit: metre^(-3)mole^(1)
    _class_parameter[102] = PFILE(181) * 1.6605387280149534e-18;
    //k_APC_death, mwd9458470_2090_4cf9_a05c_ec4c798bf39a, index: 103
    //Unit: second^(-1)
    _class_parameter[103] = PFILE(182) * 1.15740740740741e-05;
    //k_mAPC_death, mwc1053526_9f3a_4484_896f_349d13fa704b, index: 104
    //Unit: second^(-1)
    _class_parameter[104] = PFILE(183) * 1.15740740740741e-05;
    //Ckine_Mat0, mwafcf621f_9711_4d5c_a676_ba79e5616ac7, index: 105
    //Unit: metre^(-3)mole^(1)
    _class_parameter[105] = PFILE(184) * 999.9999999999994;
    //k_Ckine_Mat_deg, mwd5056d40_479c_4fde_9794_7b0a499f51f3, index: 106
    //Unit: second^(-1)
    _class_parameter[106] = PFILE(185) * 1.15740740740741e-05;
    //K_Ckine_Mat_Cp, mw80a882d6_2d8c_4150_adbb_a938daba314f, index: 107
    //Unit: metre^(-3)mole^(1)
    _class_parameter[107] = PFILE(186) * 0.0010000000000000005;
    //k_APC_mat, mw1e14fe3e_ace8_47a4_9238_595d4561f76d, index: 108
    //Unit: second^(-1)
    _class_parameter[108] = PFILE(187) * 1.15740740740741e-05;
    //K_APC_mat, mwa5d0f52b_fbff_46fd_89dc_210942d83895, index: 109
    //Unit: metre^(-3)mole^(1)
    _class_parameter[109] = PFILE(188) * 999.9999999999994;
    //k_mAPC_mig, mw580a9c71_357c_4736_a853_e2b1895c2fdc, index: 110
    //Unit: second^(-1)
    _class_parameter[110] = PFILE(189) * 1.15740740740741e-05;
    //nT_CD8_dens, mwd91e4ad7_ac80_4b63_9fcf_89162edfb3d3, index: 111
    //Unit: metre^(-3)mole^(1)
    _class_parameter[111] = PFILE(190) * 1.6605387280149534e-18;
    //nT_CD4_dens, mw469e4c28_a053_4793_a189_742b11414af8, index: 112
    //Unit: metre^(-3)mole^(1)
    _class_parameter[112] = PFILE(191) * 1.6605387280149534e-18;
    //k_nT_entry, mwfacac3eb_499c_4abe_ba99_1a4441743888, index: 113
    //Unit: metre^(-3)second^(-1)
    _class_parameter[113] = PFILE(192) * 11.574074074074097;
    //k_nT_exit, mwe9b44714_af76_4034_b535_6f883f68f6ad, index: 114
    //Unit: second^(-1)
    _class_parameter[114] = PFILE(193) * 1.15740740740741e-05;
    //nT_CD8_diver, mwdc1aa388_4ff6_439b_9603_72fe6d6a03db, index: 115
    //Unit: dimensionless^(1)
    _class_parameter[115] = PFILE(194) * 1.0;
    //nT_CD4_diver, mwe28c5a02_5c1e_49cb_a141_680f0bf3537d, index: 116
    //Unit: dimensionless^(1)
    _class_parameter[116] = PFILE(195) * 1.0;
    //k_nTCD8_mAPC, mwe6eeff6d_21d5_4bf5_93f3_a555d08b9e48, index: 117
    //Unit: second^(-1)
    _class_parameter[117] = PFILE(196) * 1.15740740740741e-05;
    //n_sites_mAPC, mw8d88209a_91e3_499c_a466_13022f5e66d3, index: 118
    //Unit: dimensionless^(1)
    _class_parameter[118] = PFILE(197) * 1.0;
    //K_p_M, mwb44a8e34_f41b_4658_9774_20e0b4e23d8d, index: 119
    //Unit: mole^(1)
    _class_parameter[119] = PFILE(198) * 1.66053872801495e-24;
    //k_aT_prolif, mw6e487c74_a133_4dd3_ae4e_38e189cd715c, index: 120
    //Unit: second^(-1)
    _class_parameter[120] = PFILE(199) * 1.15740740740741e-05;
    //k_Teff_death, mw4c944997_97c4_4686_a4bc_549735e2df12, index: 121
    //Unit: second^(-1)
    _class_parameter[121] = PFILE(200) * 1.15740740740741e-05;
    //k_Teff_death_peri, mw5c0920ff_711e_4098_8e70_e15219a3f90f, index: 122
    //Unit: second^(-1)
    _class_parameter[122] = PFILE(201) * 1.15740740740741e-05;
    //k_Teff_death_by_C, mwc2977d60_9a09_42c5_9c14_27554ed75ab3, index: 123
    //Unit: second^(-1)
    _class_parameter[123] = PFILE(202) * 1.15740740740741e-05;
    //k_Teff_egress, mw7bc94128_37ad_4951_a902_9cf1929c46b3, index: 124
    //Unit: second^(-1)
    _class_parameter[124] = PFILE(203) * 0.000277777777777778;
    //k_Teff_transmig, mwba8130c1_3548_463e_b882_c2f24dba261c, index: 125
    //Unit: mole^(-1)second^(-1)
    _class_parameter[125] = PFILE(204) * 1.00369033166667e+22;
    //k_Teff_exit, mwd3c28cd4_c991_4f08_8545_1962b1902760, index: 126
    //Unit: second^(-1)
    _class_parameter[126] = PFILE(205) * 1.15740740740741e-05;
    //S_adhesion_tot, mw6839d7a0_d997_4ad0_9c67_a0bb2a497a71, index: 127
    //Unit: metre^(-3)mole^(1)
    _class_parameter[127] = PFILE(206) * 1.6605387280149534e-18;
    //S_adhesion_peri_tot, mwfe6e1278_9283_47f3_9701_03c8b6089c36, index: 128
    //Unit: metre^(-3)mole^(1)
    _class_parameter[128] = PFILE(207) * 1.6605387280149534e-18;
    //n_aT_prolif_TCR0, mwb2e6a581_05fc_4433_8533_2ac8c1fdb553, index: 129
    //Unit: dimensionless^(1)
    _class_parameter[129] = PFILE(213) * 1.0;
    //n_aT_prolif_IL20, mw8256e539_1467_4190_96d4_947ccdcd04f7, index: 130
    //Unit: dimensionless^(1)
    _class_parameter[130] = PFILE(214) * 1.0;
    //n_aT_prolif_Coestim0, mw7b7b8f32_a479_400d_8b7a_ad1f061fd0ef, index: 131
    //Unit: dimensionless^(1)
    _class_parameter[131] = PFILE(215) * 1.0;
    //K_IL2_Teff, mwde9ecd9a_9f1b_4d51_a53e_d134b3348896, index: 132
    //Unit: metre^(-3)mole^(1)
    _class_parameter[132] = PFILE(216) * 1.0000000000000008e-06;
    //k_IL2_rel, mwd137168f_f48e_4fa9_b81f_82ea1fd94292, index: 133
    //Unit: second^(-1)
    _class_parameter[133] = PFILE(217) * 167281721944.444;
    //k_IL2_deg, mw7ef5bcec_f071_4605_831a_872aba02b16f, index: 134
    //Unit: second^(-1)
    _class_parameter[134] = PFILE(218) * 0.0166666666666667;
    //k_IL2_consump, mw6a81469c_969c_4e01_838c_5a47faabdc9f, index: 135
    //Unit: second^(-1)
    _class_parameter[135] = PFILE(219) * 167281721944.444;
    //k_nTCD4_APC, mw34a0a877_c802_4dbb_bef5_9ef62ce1f53a, index: 136
    //Unit: second^(-1)
    _class_parameter[136] = PFILE(224) * 1.15740740740741e-05;
    //n_sites_APC, mwbc9d5a6c_a0ff_403f_8476_78eec4b30888, index: 137
    //Unit: dimensionless^(1)
    _class_parameter[137] = PFILE(225) * 1.0;
    //K_Cp, mw6359ccf3_db09_4e7b_b361_60b496d3cab2, index: 138
    //Unit: metre^(-3)mole^(1)
    _class_parameter[138] = PFILE(226) * 0.0010000000000000005;
    //k_aTreg_prolif, mw1141b6ef_52d2_43e5_bcf0_a3130aac34da, index: 139
    //Unit: second^(-1)
    _class_parameter[139] = PFILE(227) * 1.15740740740741e-05;
    //K_IL2_Treg, mw721d8acc_9984_401a_9459_e8cae982cc78, index: 140
    //Unit: metre^(-3)mole^(1)
    _class_parameter[140] = PFILE(228) * 1.0000000000000008e-06;
    //nTreg_basal, mw41b0ede7_ff51_44a8_91fb_e50878093492, index: 141
    //Unit: mole^(1)
    _class_parameter[141] = PFILE(229) * 1.66053872801495e-24;
    //k_Treg_death, mw4bb29e34_500d_4cdd_a1e8_61e5cc530df4, index: 142
    //Unit: second^(-1)
    _class_parameter[142] = PFILE(230) * 1.15740740740741e-05;
    //k_Treg_egress, mw16d82821_1b4c_4b89_83b4_afe37630fa82, index: 143
    //Unit: second^(-1)
    _class_parameter[143] = PFILE(231) * 1.15740740740741e-05;
    //k_Treg_transmig, mwcd4e98db_1596_40e8_af08_b52086449c00, index: 144
    //Unit: mole^(-1)second^(-1)
    _class_parameter[144] = PFILE(232) * 1.00369033166667e+22;
    //k_Treg_exit, mw674faf4c_a5d6_457a_a4db_eaaf651448c7, index: 145
    //Unit: second^(-1)
    _class_parameter[145] = PFILE(233) * 0.0166666666666667;
    //k_Teff_inhibBy_Treg, mwe684b4c3_6e56_4c8d_a5a2_343a9f8b5b7f, index: 146
    //Unit: second^(-1)
    _class_parameter[146] = PFILE(234) * 1.15740740740741e-05;
    //K_Treg_inhib, mw062a2431_8623_4b64_957b_3934339b4156, index: 147
    //Unit: metre^(-3)mole^(1)
    _class_parameter[147] = PFILE(235) * 999.9999999999994;
}

void ODE_system::setupVariables(void){

    _species_var = std::vector<realtype>(47, 0);
    _nonspecies_var = std::vector<realtype>(7, 0);
...
void ODE_system::setup_instance_varaibles(Param& param){
    ...
    //t_inter_Nivo, mw0a05dc7c_e6fa_492a_b177_c7cab8583a7b, index: 5
    //Unit: second^(1)
    _nonspecies_var[5] = PFILE(134) * 86400.0;
    //dose_mg_Nivo, mw7550eba6_90bb_440a_9f47_36b1db39e96a, index: 6
    //Unit: dimensionless^(1)
    _nonspecies_var[6] = PFILE(126) * 1e-06;
...
void ODE_system::eval_init_assignment(void){
    ...
    _class_parameter[61] = _class_parameter[8] * _nonspecies_var[6] / _class_parameter[60];
    _nonspecies_var[1] = _class_parameter[63];
    _nonspecies_var[3] = _class_parameter[63] + _class_parameter[65];
    _species_var[13] = _class_parameter[70];
    _class_parameter[3] = _class_parameter[71];
    _class_parameter[4] = _class_parameter[72];
...
int ODE_system::f(realtype t, N_Vector y, N_Vector ydot, void *user_data){
    ...
    realtype AUX_VAR_k_on2_Nivo = PARAM(62) * PARAM(59) / (PARAM(34) * PARAM(35) * PARAM(6));

    realtype AUX_VAR_k_off_PD1_PDL1 = PARAM(73) * PARAM(74);

    realtype AUX_VAR_k_off_PD1_PDL2 = PARAM(76) * PARAM(77);

    realtype AUX_VAR_k_off_p1_0_M1 = PARAM(96) * PARAM(97);

    realtype AUX_VAR_k_off_cpt_M1 = PARAM(98) * PARAM(99);

    realtype AUX_VAR_n_aT_prolif_TCR = PARAM(129);

    realtype AUX_VAR_n_aT_prolif_IL2 = PARAM(130) * (SPVAR(32) / PARAM(23)) / (SPVAR(32) / PARAM(23) + PARAM(132)) + 0.001;

    realtype AUX_VAR_n_aT_prolif_Coestim = PARAM(131);

    realtype AUX_VAR_n_Treg_prolif_IL2 = PARAM(130) * (SPVAR(32) / PARAM(23)) / (SPVAR(32) / PARAM(23) + PARAM(140));

    realtype AUX_VAR_Teff2TregRatio = SPVAR(23) / SPVAR(12);

    realtype AUX_VAR_nT_CD8 = PARAM(111) * AUX_VAR_Cent;

    realtype AUX_VAR_nT_CD4 = PARAM(112) * AUX_VAR_Cent;

    realtype AUX_VAR_S_adhesion_peri = PARAM(128) * AUX_VAR_Peri;

    realtype AUX_VAR_S_adhesion = PARAM(127) * AUX_VAR_Tum * SPVAR(7) / PARAM(38);
    ...
    realtype AUX_VAR_clonality = 1.0 + (PARAM(95) * (SPVAR(2) / PARAM(95) / AUX_VAR_T_all_Cent) * log2(SPVAR(2) / PARAM(95) / AUX_VAR_T_all_Cent) + PARAM(115) * (AUX_VAR_nT_CD8 / PARAM(115) / AUX_VAR_T_all_Cent) * log2(AUX_VAR_nT_CD8 / PARAM(115) / AUX_VAR_T_all_Cent)) / log2(PARAM(115) + PARAM(95));
    ...
    realtype ReactionFlux3 = PARAM(40) * SPVAR(7) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0));

    realtype ReactionFlux4 = PARAM(42) * SPVAR(7) * PARAM(41);

	realtype ReactionFlux5 = 0;// -PARAM(37) * SPVAR(7) * (1.0 - SPVAR(7) / PARAM(38)) + PARAM(39) * SPVAR(7) + PARAM(40) * SPVAR(7) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0)) + PARAM(42) * SPVAR(7) * PARAM(41);

    realtype ReactionFlux6 = PARAM(39) * SPVAR(7) * PARAM(94) * PARAM(44) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux7 = PARAM(40) * SPVAR(7) * PARAM(94) * PARAM(44) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0)) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux8 = PARAM(42) * SPVAR(7) * PARAM(41) * PARAM(94) * PARAM(44) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux9 = PARAM(46) * SPVAR(8) * AUX_VAR_Tum;

    realtype ReactionFlux10 = PARAM(39) * SPVAR(7) * PARAM(95) * PARAM(43) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux11 = PARAM(40) * SPVAR(7) * PARAM(43) * PARAM(95) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0)) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux12 = PARAM(42) * PARAM(95) * SPVAR(7) * PARAM(41) * PARAM(43) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));
    ...
    realtype ReactionFlux18 = PARAM(91) * PARAM(90);

    realtype ReactionFlux19 = PARAM(91) * SPVAR(39);

    realtype ReactionFlux20 = PARAM(92) * SPVAR(45);

    realtype ReactionFlux21 = PARAM(82) * PARAM(80) * SPVAR(8) / PARAM(22);

    realtype ReactionFlux22 = PARAM(83) * SPVAR(37);

    realtype ReactionFlux23 = PARAM(83) * PARAM(81) * SPVAR(37);

    realtype ReactionFlux24 = PARAM(99) * SPVAR(39) * SPVAR(38) / PARAM(79) - AUX_VAR_k_off_cpt_M1 * SPVAR(40);

    realtype ReactionFlux25 = PARAM(84) * SPVAR(38);

    realtype ReactionFlux26 = PARAM(85) * SPVAR(40);

    realtype ReactionFlux27 = PARAM(100) * SPVAR(40);

    realtype ReactionFlux28 = AUX_VAR_k_off_cpt_M1 * SPVAR(44);

    realtype ReactionFlux29 = PARAM(86) * PARAM(80) * SPVAR(22) / PARAM(22);

    realtype ReactionFlux30 = PARAM(87) * SPVAR(41);

    realtype ReactionFlux31 = PARAM(87) * PARAM(81) * SPVAR(41);

    realtype ReactionFlux32 = PARAM(97) * SPVAR(39) * SPVAR(42) / PARAM(79) - AUX_VAR_k_off_p1_0_M1 * SPVAR(43);

    realtype ReactionFlux33 = PARAM(88) * SPVAR(42);

    realtype ReactionFlux34 = PARAM(89) * SPVAR(43);

    realtype ReactionFlux35 = PARAM(93) * SPVAR(43);

    realtype ReactionFlux36 = AUX_VAR_k_off_p1_0_M1 * SPVAR(46);

    realtype ReactionFlux37 = PARAM(103) * SPVAR(7) / PARAM(38) * PARAM(101) * AUX_VAR_Tum;

    realtype ReactionFlux38 = PARAM(103) * SPVAR(9);

    realtype ReactionFlux39 = PARAM(106) * PARAM(105) * AUX_VAR_Tum;

    realtype ReactionFlux40 = PARAM(40) * SPVAR(7) * PARAM(45) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * (0.0 + 1.0 - std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0)) * PARAM(38) / (SPVAR(7) + 1.0 * PARAM(7));

    realtype ReactionFlux41 = PARAM(106) * SPVAR(11) * AUX_VAR_Tum;

    realtype ReactionFlux42 = PARAM(108) * SPVAR(9) * SPVAR(11) / (PARAM(109) + SPVAR(11));

    realtype ReactionFlux43 = PARAM(110) * SPVAR(10);

    realtype ReactionFlux44 = PARAM(104) * SPVAR(27);

    realtype ReactionFlux45 = PARAM(103) * PARAM(102) * AUX_VAR_LN;

    realtype ReactionFlux46 = PARAM(103) * SPVAR(26);

    realtype ReactionFlux47 = PARAM(133) * SPVAR(35);

    realtype ReactionFlux48 = PARAM(134) * SPVAR(32) * AUX_VAR_LN;

    realtype ReactionFlux49 = PARAM(135) * SPVAR(30) * (SPVAR(32) / PARAM(23) / (PARAM(140) + SPVAR(32) / PARAM(23)));

    realtype ReactionFlux50 = PARAM(135) * SPVAR(35) * (SPVAR(32) / PARAM(23) / (PARAM(132) + SPVAR(32) / PARAM(23)));

    realtype ReactionFlux51 = PARAM(113) * AUX_VAR_nT_CD8 * AUX_VAR_LN;

    realtype ReactionFlux52 = PARAM(114) * SPVAR(28);

    realtype ReactionFlux53 = PARAM(117) * PARAM(95) * (SPVAR(28) / PARAM(115)) * (PARAM(118) * SPVAR(27) / (PARAM(118) * SPVAR(27) + SPVAR(28) / PARAM(115))) * (AUX_VAR_p1_0_M / PARAM(95) / (AUX_VAR_p1_0_M / PARAM(95) + PARAM(119)));

    realtype ReactionFlux54 = PARAM(120) / AUX_VAR_n_aT_prolif * SPVAR(35);

    realtype ReactionFlux55 = PARAM(120) / AUX_VAR_n_aT_prolif * std::pow(2.0, AUX_VAR_n_aT_prolif) * SPVAR(35);

    realtype ReactionFlux56 = PARAM(121) * SPVAR(36);

    realtype ReactionFlux57 = PARAM(124) * SPVAR(36);

    realtype ReactionFlux58 = PARAM(121) * SPVAR(2);

    realtype ReactionFlux59 = PARAM(125) * AUX_VAR_S_adhesion * SPVAR(2) * AUX_VAR_Tum * SPVAR(7) / PARAM(38) * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux60 = PARAM(121) * SPVAR(23);

    realtype ReactionFlux61 = PARAM(123) * SPVAR(7) * SPVAR(23) / (SPVAR(7) + AUX_VAR_T_all_Tum) * ((SPVAR(20) + SPVAR(21)) / (SPVAR(20) + SPVAR(21) + PARAM(75)));

    realtype ReactionFlux62 = PARAM(121) * SPVAR(24);

    realtype ReactionFlux63 = PARAM(125) * AUX_VAR_S_adhesion_peri * SPVAR(2) * AUX_VAR_Peri * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux64 = PARAM(126) * SPVAR(5);

    realtype ReactionFlux65 = PARAM(122) * SPVAR(5);

    realtype ReactionFlux66 = PARAM(113) * AUX_VAR_nT_CD4 * AUX_VAR_LN;

    realtype ReactionFlux67 = PARAM(114) * SPVAR(29);

    realtype ReactionFlux68 = PARAM(136) * PARAM(94) * (SPVAR(29) / PARAM(116)) * (PARAM(137) * SPVAR(26) / (PARAM(137) * SPVAR(26) + SPVAR(29) / PARAM(116))) * (AUX_VAR_cpt_M / PARAM(94) / (AUX_VAR_cpt_M / PARAM(94) + PARAM(119)));

    realtype ReactionFlux69 = PARAM(139) / AUX_VAR_n_Treg_prolif_IL2 * SPVAR(30);

    realtype ReactionFlux70 = PARAM(139) / AUX_VAR_n_Treg_prolif_IL2 * std::pow(2.0, AUX_VAR_n_Treg_prolif_IL2) * SPVAR(30);

    realtype ReactionFlux71 = PARAM(142) * SPVAR(31);

    realtype ReactionFlux72 = PARAM(143) * SPVAR(31);

    realtype ReactionFlux73 = PARAM(142) * SPVAR(1);

    realtype ReactionFlux74 = PARAM(142) * PARAM(141);

    realtype ReactionFlux75 = PARAM(144) * AUX_VAR_S_adhesion * SPVAR(1) * AUX_VAR_Tum * SPVAR(7) / PARAM(38) * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux76 = PARAM(142) * SPVAR(12);

    realtype ReactionFlux77 = PARAM(144) * AUX_VAR_S_adhesion_peri * SPVAR(1) * AUX_VAR_Peri * PARAM(24) / AUX_VAR_Cent;

    realtype ReactionFlux78 = PARAM(145) * SPVAR(4);

    realtype ReactionFlux79 = PARAM(142) * SPVAR(4);

    realtype ReactionFlux80 = PARAM(146) * SPVAR(23) * (SPVAR(12) / (SPVAR(7) + AUX_VAR_T_all_Tum)) * (1.0 + std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) / (std::pow((SPVAR(20) + SPVAR(21)) / PARAM(75), PARAM(78)) + 1.0));

    realtype ReactionFlux81 = PARAM(74) * SPVAR(14) * SPVAR(18) / PARAM(34) - AUX_VAR_k_off_PD1_PDL1 * SPVAR(20);

    realtype ReactionFlux82 = PARAM(77) * SPVAR(14) * SPVAR(19) / PARAM(34) - AUX_VAR_k_off_PD1_PDL2 * SPVAR(21);
    ...
    realtype ReactionFlux86 = NSPVAR(4) / PARAM(69);

    realtype ReactionFlux87 = PARAM(66) * SPVAR(0) * AUX_VAR_Cent;

    realtype ReactionFlux88 = PARAM(51) * PARAM(68) * PARAM(54) * AUX_VAR_Peri * SPVAR(0) / PARAM(69) - PARAM(51) * PARAM(68) * PARAM(54) * AUX_VAR_Peri * SPVAR(3) / PARAM(67);

    realtype ReactionFlux89 = PARAM(52) * PARAM(55) * AUX_VAR_Tum * SPVAR(0) / PARAM(69) - PARAM(52) * PARAM(55) * AUX_VAR_Tum * SPVAR(6) / PARAM(22);

    realtype ReactionFlux90 = PARAM(53) * PARAM(68) * PARAM(56) * AUX_VAR_LN * SPVAR(0) / PARAM(69) - PARAM(53) * PARAM(68) * PARAM(56) * AUX_VAR_LN * SPVAR(25) / PARAM(23);
...
bool ODE_system::triggerComponentEvaluate(int i, realtype t, bool curr) {
    ...
    case 3:
        //count_dose_Nivo < (n_dose_Nivo)
        eval = _nonspecies_var[2] < (_class_parameter[64]);
        discrete = true;
        break;
    case 4:
        //t > (t_off_Nivo)
...
bool ODE_system::eventExecution(int i, bool delayed, realtype& dt){
    ...
    case 2:
        ...
        break;
    case 3:
        _nonspecies_var[1] = _nonspecies_var[1] + _nonspecies_var[5];
        _nonspecies_var[2] = _nonspecies_var[2] + 1.0;
        break;
    case 4:
        _nonspecies_var[3] = _nonspecies_var[3] + _nonspecies_var[5];
        break;
    case 5:
        _nonspecies_var[4] = _class_parameter[61] / _class_parameter[65];
        break;
    case 6:
...
void ODE_system::update_y_other(void){
    ...
    realtype AUX_VAR_nT_CD8 = _class_parameter[111] * AUX_VAR_Cent;

    realtype AUX_VAR_nT_CD4 = _class_parameter[112] * AUX_VAR_Cent;
