...
void ODE_system::setup_class_parameters(Param& param){
    ...
    //Unit: metre^(3)
    _class_parameter[16] = QSP_W * PFILE(76) * 0.0010000000000000007;
...
void ODE_system::setup_instance_varaibles(Param& param){
    ...
    //Unit: mole^(1)metre^(-3)
    _species_var[8] =  QSP_W * PFILE(21) * 1000.0;
    ...
    //Unit: mole^(1)
    _species_var[12] =  QSP_W * PFILE(26) * 1.66053872801495e-24;
    ...
    //Unit: mole^(1)metre^(-3)
    _species_var[22] =  QSP_W * PFILE(38) * 1000.0;
    //Tum.Teff_1_0, mw7a727f1f_a564_4bfa_ab65_c2255ce344ff, index: 23
    //Unit: mole^(1)
    _species_var[23] =  QSP_W * PFILE(39) * 1.66053872801495e-24;
    //Tum.Teff_exhausted, mw6b1e6284_c8a9_4f46_b2d4_ab47548cdb6b, index: 24
    //Unit: mole^(1)
    _species_var[24] =  QSP_W * PFILE(40) * 1.66053872801495e-24;
...
int ODE_system::f(realtype t, N_Vector y, N_Vector ydot, void *user_data){
    ...
    realtype ReactionFlux75 = QSP_W * (PARAM(146) * AUX_VAR_S_adhesion * SPVAR(1) * AUX_VAR_Tum * SPVAR(7) / PARAM(38) * PARAM(24) / AUX_VAR_Cent);
